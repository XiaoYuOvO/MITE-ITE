...
public class Configs {
    ...
    private static final ConfigCategory ROOT = new ConfigCategory("root").
            addEntry(ConfigCategory.of("GameMechanics").
                    ...
                    addEntry(ConfigCategory.of("Underworld").
                            ...
                            addEntry(ConfigEntry.of("underworld_random_teleport_time",GameMechanics.Underworld.UNDERWORLD_RANDOM_TELEPORT_TIME).withComment("地底世界随机传送时间(整数)")).
                            ...
                            addEntry(ConfigEntry.of("underworld_debuff_period3",GameMechanics.Underworld.UNDERWORLD_DEBUFF_PERIOD3).withComment("地底世界负面效果第三阶段触发时间(整数)"))).
    ...
    public static class GameMechanics{
        ...
        public static final FieldReference<Double> STEPPED_MOB_DAMAGE_PROGRESS_BASE = new FieldReference<>(2d);
        public static final FieldReference<Integer> STEPPED_MOB_DAMAGE_PROGRESS_INCREASE_DAY = new FieldReference<>(64);
        public static final FieldReference<Double> STEPPED_MOB_DAMAGE_PROGRESS_MAX = new FieldReference<>(6d);
