...
@Deceive(EntityEnderDragon.class)
public class EntityEnderDragonLiar extends EntityInsentient implements IComplex{
    @Liar
    ...
    @Stealing
    public EntityEnderDragonLiar(World par1World) {
        super(par1World);
    }
