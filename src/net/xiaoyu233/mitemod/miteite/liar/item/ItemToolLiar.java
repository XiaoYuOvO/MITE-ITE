...
public class ItemToolLiar extends Item {
    @Liar
    ...
    public boolean a(ItemStack par1ItemStack, EntityLiving par2EntityLivingBase, EntityLiving par3EntityLivingBase) {
        ...
        if (par2EntityLivingBase.onClient()) {
            atv.setErrorMessage("ItemTool.hitEntity: called on client?");
        }
    ...
    public boolean onBlockDestroyed(BlockBreakInfo info) {
        if (info.world.I) {
            atv.setErrorMessage("ItemTool.onBlockDestroyed: called on client?");
        }
    ...
    public void onItemLevelUp(NBTTagCompound tagCompound, EntityHuman player, ItemStack stack) {
        ...
        if (modifiers.b(modifierType.nbtName)) {
            ...
            int i = this.addModifierLevelFor(modifiers,modifierType);
            player.a(ChatMessage.e(
    ...
    @Stealing
    private int getToolDecayFromAttackingEntity(ItemStack par1ItemStack, EntityLiving par2EntityLivingBase) {
        return 0;
    }
