...
public enum ArmorModifierTypes implements ItemModifierTypes{
    //Armor Modifiers
    DURABILITY_MODIFIER(0.1F,"持久",EnumChatFormatting.DARK_PURPLE,20,5,(stack -> true)),
    PROJECTILE_PROTECTION_MODIFIER(0.5F,"弹射物保护", EnumChatFormats.DARK_GREY,7,5,(stack -> hasNotOtherProtectionModifier(stack,3))),
    EXPLOSION_PROTECTION_MODIFIER(0.5F,"爆炸保护", EnumChatFormatting.DARK_RED,7,5,(stack -> hasNotOtherProtectionModifier(stack,2))),
    FIRE_PROTECTION_MODIFIER(0.5F,"火焰保护", EnumChatFormats.LIGHT_ORANGE,7,5,(stack -> hasNotOtherProtectionModifier(stack,0))),
    PROTECTION_MODIFIER(0.25F,"保护",EnumChatFormatting.WHITE,5,5,(stack -> hasNotOtherProtectionModifier(stack,1))),
    STEADY_MODIFIER(0.15F,"稳定",EnumChatFormatting.DARK_GRAY,8,5,(stack -> true)),
    ...
    IMMUNITY(0.15f,"免疫",EnumChatFormatting.GREEN,3,4,itemStack -> itemStack.getItem() instanceof ItemHelmet);
    ...
    ArmorModifierTypes(float levelAddition, String displayName, EnumChatFormatting color, int weight,int maxLevel, Predicate<ItemStack> canApplyTo){
